  ...
  <Teleport to="body">
    <Transition name="modal">
      <div v-if="open" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div
          class="relative z-10 w-full overflow-hidden rounded-3xl bg-surface shadow-lift animate-fade-up"
          :style="{ maxWidth: width || '32rem' }"
        >
          <header v-if="title" class="flex items-center justify-between border-b border-line px-6 py-4">
